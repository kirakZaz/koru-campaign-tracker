    ...
    return (
        <Box sx={{ flex: 1, overflow: 'auto', px: { xs: 2, md: 4 }, py: 3 }}>
            ...
            <Typography sx={{ fontSize: '0.85rem', color: 'text.secondary', mb: 3 }}>
                Как мы набираем юзеров (платят или тестят): недельный круг, тёплый заход, активация, раскрутка. Цель — 15 активных юзеров к релизу 10.10. Всё remote, без звонков. Активация важнее набора.
            </Typography>
            ...
            {/* 5. Activation */}
            <Box sx={sectionSx}>
                <Typography sx={titleSx}>5. Активация юзеров (главная проблема)</Typography>
                <Typography sx={textSx}>
                    Согласиться — не значит пользоваться. Мёртвый аккаунт = не тот ICP или продукт дали «пустым». Лечим <strong>поводом</strong>, а не напоминанием верифнуть. Нам всё равно, тестер или платящий — важно, что <strong>реально пользуется</strong>.
                </Typography>
                <Box component="ul" sx={listSx}>
                    ...
                    <li>Сделал → дай пользоваться: <strong>платит — супер</strong>; не готов — ранний доступ / tester plan (месяц free за фидбек). Пай-готовых не гони через тест-договор.</li>
            ...
            {/* 8. Channels */}
            <Box sx={sectionSx}>
                <Typography sx={titleSx}>8. Каналы раскрутки (движок)</Typography>
                <Typography sx={textSx}>
                    Founder-outreach — один из каналов, не единственный. Раскручиваем бесплатный чекер предсказуемо. Полные инструкции — в задачах (ссылка 📖 в каждой).
                </Typography>
                <Box component="ul" sx={listSx}>
                    <li><strong>Комьюнити</strong> (Reddit r/SEO, r/bigseo, r/TechSEO; SEO Discord) — кейс-посты «прогнали N сайтов, вот почему AI берёт одни и игнорит другие», не реклама. 1/нед, ротация площадки.</li>
                    <li><strong>Каталоги</strong> (There’s An AI For That, Futurepedia, BetaList) — разово, дёшево, международные юзеры.</li>
                    <li><strong>Product Hunt</strong> — разовый всплеск + кредибилити. Только с подготовкой (ассеты, хантер, пре-warm аудитории). Веха перед 10.10.</li>
                    <li><strong>Шеринг результата</strong> — бесплатный результат должен быть легко публикуем (задача Максу) → работает как вирусный лид-магнит.</li>
                </Box>
            </Box>

            {/* 9. Metrics */}
            <Box sx={sectionSx}>
                <Typography sx={titleSx}>9. Метрики</Typography>
                <Typography sx={textSx}>
                    Смотрим на разговоры, первые действия и <strong>активных юзеров</strong> (платят или тестят) — НЕ на показы постов. Воронка: Нашёл → CR → Ответ → Первое действие → Активный. Цель — 15 активных к 10.10.
                </Typography>
            </Box>
        </Box>
    )
